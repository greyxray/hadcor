...
class selector {
 public :
  ...
  Double_t        max_et_accomp_jet_had_level;
  Double_t        max_et_accomp_jet_had_level_eta;
  Double_t        glob_fmax;
  ...
  TLorentzVector  *v_true_parton_acc_jet;
  TLorentzVector *v_true_scattered_electron;
  ...
  */
  ...
  Float_t         myKzufodeltaz[250]; //to divide by 5.45
   ...
   Int_t           nqg;
   Int_t           quarkprt;
   UShort_t        idqg[255];   //[nqg]
   Short_t         doqg[255];   //[nqg]
   Int_t           prtqg[255];   //[nqg]
   ...
   UChar_t         E5xdet[4][3];   //[E5ncand]
   UChar_t         E5ydet[4][3];   //[E5ncand]
   UChar_t         E5trknr[4];   //[E5ncand]
   UChar_t         E5nrsl[4];   //[E5ncand]
   ...
   UChar_t         E5ncell[4];   //[E5ncand]
   UShort_t        E5cellptr[4];   //[E5ncand]
   ...
   UChar_t         E5calprobrank[4];   //[E5ncand]
   ...
   Int_t           idlepton;
   Int_t           idphoton;
   UShort_t        Part_id[511];   //[Npart]
   UShort_t        Part_motherid[511];   //[Npart]
   UShort_t        Part_motherprt[511];   //[Npart]
   ...
   Int_t           filter;
   Int_t           npart_my;
   UChar_t         Part_jetid[511];   //[npart_my]
   ...
   Int_t           Knjets;
   Float_t         Kpjets[200][4];   //[Knjets]
   Float_t         Kpjetet[200];   //[Knjets]
   Float_t         Kpjetpt[200];   //[Knjets]
   Float_t         Kpjeteta[200];   //[Knjets]
   Float_t         Kpjetphi[200];   //[Knjets]
   UChar_t         Kpjetnzu[200];   //[Knjets]
   Float_t         Kpjetemcfrac[200];   //[Knjets]
   UChar_t         Kpjetnisl[200];   //[Knjets]
   Float_t         Kpjetfmax[200];   //[Knjets]
   Float_t         Kpjetdeltaz[200];   //[Knjets]
   Int_t           Ktrnjets;
   Float_t         Ktrjets[200][4];   //[Ktrnjets]
   Float_t         Ktrjetet[200];   //[Ktrnjets]
   Float_t         Ktrjetpt[200];   //[Ktrnjets]
   Float_t         Ktrjeteta[200];   //[Ktrnjets]
   Float_t         Ktrjetphi[200];   //[Ktrnjets]
   Int_t           Ktrjetntrac[200];   //[Ktrnjets]
   Int_t           Ktrjetchar[200];   //[Ktrnjets]
   Int_t           Knzufos;
   ...
   UChar_t         Kzufotype[1000];   //[Knzufos]
   UChar_t         Kzufoidjet[1000];   //[Knzufos]
...
void selector::Init(TTree *tree, TString run_period, Bool_t b_Data, TString s_mc_type, TString s_mc_corr_type, Bool_t b_usecorr, Bool_t b_use2ndcorr, Bool_t b_use_clustered)
{
  ...
  fChain->SetMakeClass(1);
   ...
   fChain->SetBranchAddress("fmce5true", fmce5true, &b_fmce5true);
   fChain->SetBranchAddress("fmce5npart", fmce5npart, &b_fmce5npart);
   fChain->SetBranchAddress("fmce5partlist", fmce5partlist, &b_fmce5partlist);
   fChain->SetBranchAddress("fmce5enelist", fmce5enelist, &b_fmce5enelist);
   ...
   fChain->SetBranchAddress("npart_my", &npart_my, &b_npart_my);
   ...
   fChain->SetBranchAddress("photprphjetindex", &photprphjetindex, &b_photprphjetindex);
   fChain->SetBranchAddress("photid", Photid, &b_photid);
   fChain->SetBranchAddress("photp", Photp, &b_photp);
   fChain->SetBranchAddress("photmothprt", photmothprt, &b_photmothprt);
   fChain->SetBranchAddress("photmothid", photmothid, &b_photmothid);
   fChain->SetBranchAddress("photisthep", photisthep, &b_photisthep);
