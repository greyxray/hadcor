...
int main(int argc, char *argv[])
{
  ...
  set_hist_atributes(40, "h_had_ijet_q2", "inclusive jets, had. level", "Q^{2} (GeV^{2})", "Jets", 0., 100., 0.1, kTRUE, 10);
  set_hist_atributes(41, "h_had_ijet_pt_breit", "inclusive jets, had.level", "P_{T,Breit} (GeV)", "Jets", 0., 120., 0.1, kTRUE, 10);
  set_hist_atributes(42, "h_had_ijet_eta_lab", "inclusive jets, had.level", "#eta_{Lab}", "Jets", -1., 2.5, 0.1, kFALSE, 10);
  set_hist_atributes(43, "h_had_ijet_pt_lab", "inclusive jets, had.level", "P_{T,Lab} (GeV)", "Jets", 0., 120., 0.1, kTRUE, 10);

  set_hist_atributes(44, "h_had_ijet_x", "inclusive jets, had. level", "x", "Jets", 1.e-5, 5.e-3, 0.1, kTRUE, 10);
  set_hist_atributes(45, "h_had_ijet_y", "inclusive jets, had.level", "y", "Jets", 0.1, 0.7, 0.1, kFALSE, 10);
  set_hist_atributes(46, "h_had_ijet_eta_lab", "inclusive jets, had.level", "#eta_{Lab}", "Jets", -1., 2.5, 0.1, kFALSE, 10);
  set_hist_atributes(47, "h_had_ijet_pt_lab", "inclusive jets, had.level", "P_{T,Lab} (GeV)", "Jets", 0., 120., 0.1, kTRUE, 10);
...
// 			     "h_part_px", "h_part_py", "h_part_pz", "h_part_e"  
  ...
  for(Int_t i=0; i<n_hist; i++) {
    ...
    c1[i/4]->GetPad(i%4+1)->SetLogx(hist_logx[i]);
  }
