...
int main(int argc, char *argv[])
{
  ...
  h_window[0] = new TH2D("h_window0", "", 10, 15., 600., 10, 0.1, 10. * hist2[0]->GetMaximum());
  h_window[1] = new TH2D("h_window1", "", 10, 0., 50., 10, 0.1, 10. * hist2[1]->GetMaximum());
  ...
  c1->Print("mc_id_hanno_common.lt.60.eps");
