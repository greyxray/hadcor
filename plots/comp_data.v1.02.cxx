...
int main(int argc, char *argv[])
{
  ...
  set_hist_atributes(1, "h_empz", "inclusive DIS", "E-P_{z} (GeV)", "Events", 0, 80, 0.1, kTRUE, 1);
  set_hist_atributes(2, "h_E_el", "inclusive DIS", "E_{e, EL} (GeV)", "Events", 0, 40, 0.1, kTRUE, 1);
  set_hist_atributes(3, "h_E_da", "inclusive DIS", "E_{e, DA} (GeV)", "Events", 0, 40, 0.1, kTRUE, 1);

  set_hist_atributes(4, "h_y_e_calc", "inclusive DIS", "y_{el}", "Events", 0, 1, 0.1, kTRUE, 1);
  set_hist_atributes(5, "h_Q2_el", "inclusive DIS", "Q^{2} (GeV^{2})", "Events", 0, 100, 0.1, kTRUE, 1);
  set_hist_atributes(6, "h_Q_el_log", "inclusive DIS", "log_{10}Q^{2}", "Events", 0, 2.5, 0.1, kTRUE, 1);
  set_hist_atributes(7, "h_Chivtx", "inclusive DIS", "#chi_{vtx}", "Events", -50, 50, 0.1, kTRUE, 1);
...
// 			     "h_part_px", "h_part_py", "h_part_pz", "h_part_e"  
  ...
  TFile *file1 = new TFile("/data/zenith234b/kuprash/analyses/jets_low_q2/60211hannoNT.root", "read"); 
  TFile *file2 = new TFile("/data/zenith234b/kuprash/analyses/jets_low_q2/60211.root");
