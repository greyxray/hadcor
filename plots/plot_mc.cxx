...
int main(int argc, char *argv[])
{
  ...
  set_hist_atributes(18, "h_part_pz_sum", "without cuts, part. level", "P_{z, sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  set_hist_atributes(19, "h_part_e_sum", "without cuts, part. level", "E_{sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  ...
  set_hist_atributes(26, "h_had_dis_pz_sum", "inclusive DIS, had. level", "P_{z, sum}^{had} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  set_hist_atributes(27, "h_had_dis_e_sum", "inclusive DIS, had. level", "E_{sum}^{had} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  ...
  set_hist_atributes(30, "h_had_ijet_pz_sum", "inclusive jets, had. level", "P_{z, sum}^{had} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  set_hist_atributes(31, "h_had_ijet_e_sum", "inclusive jets, had. level", "E_{sum}^{had} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  ...
  set_hist_atributes(34, "h_had_idijet_pz_sum", "inclusive dijets, had. level", "P_{z, sum}^{had} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  set_hist_atributes(35, "h_had_idijet_e_sum", "inclusive dijets, had. level", "E_{sum}^{had} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  ...
  set_hist_atributes(46, "h_part_dis_pz_sum", "inclusive DIS, part. level", "P_{z, sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  set_hist_atributes(47, "h_part_dis_e_sum", "inclusive DIS, part. level", "E_{sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  ...
  set_hist_atributes(50, "h_part_ijet_pz_sum", "inclusive jets, part. level", "P_{z, sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  set_hist_atributes(51, "h_part_ijet_e_sum", "inclusive jets, part. level", "E_{sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  ...
  set_hist_atributes(54, "h_part_idijet_pz_sum", "inclusive dijets, part. level", "P_{z, sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  set_hist_atributes(55, "h_part_idijet_e_sum", "inclusive dijets, part. level", "E_{sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  ...
  set_hist_atributes(80, "h_part_dijet_jetel_px_balance", "#Sigma_{dijet, el.} P_{x, part}", "P_{x, sum}^{part} (GeV)", "Events", -50., 50., 0.1, kTRUE, 1);
  set_hist_atributes(81, "h_part_dijet_jetel_py_balance", "#Sigma_{dijet, el.} P_{y, part}", "P_{y, sum}^{part} (GeV)", "Events", -50., 50., 0.1, kTRUE, 1);
  set_hist_atributes(82, "h_part_dijet_jetel_pz_balance", "#Sigma_{dijet, el.} P_{z, part}", "P_{z, sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);
  set_hist_atributes(83, "h_part_dijet_jetel_e_balance", "#Sigma_{dijet, el.} E_{part}", "E_{sum}^{part} (GeV)", "Events", -1000., 1000., 0.1, kTRUE, 1);

  //  set_hist_atributes(28, "h_had_ijet_px_sum", "inclusive jets", "P_{x, sum}^{had} (GeV)", "Particles", -1000., 1000., 0.1, kTRUE, 1);
...
//   }
  ...
  for(Int_t i=0; i<n_hist; i++) {
    ...
    c1[i/4]->GetPad(i%4+1)->SetLogy(hist_logy[i]);
  }
